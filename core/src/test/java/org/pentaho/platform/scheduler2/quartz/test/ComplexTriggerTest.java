...
public class ComplexTriggerTest {
  ...
  public void timeSliceTest() {
    ...
    trigger = (ComplexJobTrigger) quartzScheduler.createComplexTrigger( "5 15 12 ? 3 7 2010" );
    ...
    trigger = (ComplexJobTrigger) quartzScheduler.createComplexTrigger( "* * * * * ? *" );
    ...
    trigger = (ComplexJobTrigger) quartzScheduler.createComplexTrigger( "0 30,45 12,15 3,10 3,5 ? 2010,2013" );
    Assert.assertEquals( trigger.getYearlyRecurrences().size(), 1 );
    Assert.assertTrue( trigger.getYearlyRecurrences().get( 0 ) instanceof RecurrenceList );
    ...
    trigger = (ComplexJobTrigger) quartzScheduler.createComplexTrigger( "0 30-45 12-15 ? 3-5 1-7 2010-2013" );
    Assert.assertEquals( trigger.getYearlyRecurrences().size(), 1 );
    ...
    trigger = (ComplexJobTrigger) quartzScheduler.createComplexTrigger( "* 0 0 ? * 6L,1#3 *" );
    ...
    trigger =
      (ComplexJobTrigger) quartzScheduler
