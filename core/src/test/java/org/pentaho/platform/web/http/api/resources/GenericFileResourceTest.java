...
public class GenericFileResourceTest {
  ...
  public void testCreateFileSuccess() throws Exception {
    ...
    when( mockFileService.createFile( eq( path ), any( CreateFileOptions.class ), eq( content ) ) ).thenReturn( true );
  ...
  public void testCreateFileAlreadyExists() throws Exception {
    ...
    InputStream content = new ByteArrayInputStream( "test content".getBytes() );
    when( mockFileService.createFile( eq( path ), any( CreateFileOptions.class ), eq( content ) ) ).thenReturn( false );
  ...
  public void testCreateFileInvalidPath() throws Exception {
    ...
    InputStream content = new ByteArrayInputStream( "test content".getBytes() );
    when( mockFileService.createFile( eq( path ), any( CreateFileOptions.class ), eq( content ) ) )
