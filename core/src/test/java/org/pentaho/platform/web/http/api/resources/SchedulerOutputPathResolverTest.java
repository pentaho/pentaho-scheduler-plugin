...
public class SchedulerOutputPathResolverTest {
  ...
  private SchedulerConfig<Boolean> config;
  ...
  public void setUp() throws Exception {
    ...
    config = SchedulerConfig.getInstance("settings/scheduler-fallback",Boolean.class, "false");
  }
  ...
  private void configureFallbackEnabled( boolean value ) {
    when(resourceLoader.getPluginSetting(SchedulerConfig.class, "settings/scheduler-fallback", "false")).thenReturn(String.valueOf( value ));
    config.resetValue(Boolean.class, "false");
  }
